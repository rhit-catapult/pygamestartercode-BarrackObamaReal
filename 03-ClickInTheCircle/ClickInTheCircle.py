...
def main():
    ...
    # DONE: Load the "drums.wav" file into the pygame music mixer
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # DONE: If distance_from_circle is greater than the circle_radius, set the message_text to 'You missed!'
                # DONE: Start playing the music mixer looping forever if the click is within the circle

                # DONE: Stop playing the music if the click is outside the circle
        ...
        # DONE: Create a text image (render the text) based on the message_text with the color (122, 237, 201)
        caption = font.render(message_text, True, (122,237,201))
        screen.blit(instructions_image, (25, 25))
        #DONE: Draw (blit) the message to the user that says 'Bullseye!' or 'You missed!'
