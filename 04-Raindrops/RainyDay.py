...
class Cloud:
    def __init__(self, screen, x, y, image_filename):
        ...
        # DOME 24: Initialize this Cloud, as follows:
        #     - Store the screen.
...
def main():
    ...
    while True:
        ...
        # DONE 14: As a temporary test, check if test_drop is off screen, if so reset the y position to 10       if test_drop.off_screen():
